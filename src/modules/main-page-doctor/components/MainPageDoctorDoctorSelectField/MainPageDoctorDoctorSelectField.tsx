...
const MainPageDoctorDoctorSelectField = <IsMulti extends boolean = false>(props: Props<IsMulti>) => {
  const handleSearch = async (keyword: string, page: number) => {
    const { data } = await AdminDoctorsAPI.getOptionsForMainPageDoctorForm({
      ...initialQueryState,
      page,
...
export default MainPageDoctorDoctorSelectField
