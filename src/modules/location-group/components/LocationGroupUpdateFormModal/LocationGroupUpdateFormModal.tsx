...
type LocationGroupUpdateFormModalShape = FormShape<{
  image_file_path: string
}>

type LocationGroupUpdateFormModalProps = {
  isShow: boolean
  modalTitle: React.ReactNode
  initialValues?: Partial<LocationGroupUpdateFormModalShape>
  initialImageSrc?: string
  onSubmit: (values: LocationGroupUpdateFormModalShape) => Promise<void>
  onCancel: () => void
}

const defaultValues: LocationGroupUpdateFormModalShape = {
  image_file_path: '',
}

const LocationGroupUpdateFormModal: FC<LocationGroupUpdateFormModalProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Formik<LocationGroupUpdateFormModalShape>
...
export type { LocationGroupUpdateFormModalShape }

export default LocationGroupUpdateFormModal
