...
type ProjectLabelUpdateFormModalShape = FormShape<{
  map_icon_file_path: string
}>

type ProjectLabelUpdateFormModalProps = {
  isShow: boolean
  modalTitle: React.ReactNode
  initialValues?: Partial<ProjectLabelUpdateFormModalShape>
  onSubmit: (values: ProjectLabelUpdateFormModalShape) => Promise<void>
  onCancel: () => void
}

const defaultValues: ProjectLabelUpdateFormModalShape = {
  map_icon_file_path: '',
}

const ProjectLabelUpdateFormModal: FC<ProjectLabelUpdateFormModalProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Formik<ProjectLabelUpdateFormModalShape>
          ...
          >
            <Modal.Body className="scroll-y mx-5 mx-xl-15 my-7">
              ...
              <FormControl>
                ...
                <PermissionsControl
                  allow={[PermissionEnum.ADMIN_PROJECT_LABEL_UPLOAD_MAP_ICON]}
                  renderError
                >
                  <FileInputField
                    name="map_icon_file_path"
                    uploadFn={AdminProjectLabelsAPI.uploadMapIcon}
...
export type { ProjectLabelUpdateFormModalShape }

export default ProjectLabelUpdateFormModal
