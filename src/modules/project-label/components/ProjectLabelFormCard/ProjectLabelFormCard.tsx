...
type ProjectLabelFormCardShape = FormShape<{
  map_icon_file_path: string
  default_name: string
}>

type Props = {
  initialValues?: Partial<ProjectLabelFormCardShape>
  onSubmit: (values: ProjectLabelFormCardShape) => Promise<void>
  onCancel: () => void
}

const ProjectLabelFormCard: FC<Props> = ({ initialValues, onSubmit, onCancel }) => {
  const alert = useAlert()
  const [error, setError] = useState<string>()

  const initialFormValues: ProjectLabelFormCardShape = {
  ...
  return (
    <KTCard>
      <Formik<ProjectLabelFormCardShape>
              ...
              >
                <Row className="gap-7">
                  ...
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label isRequired>
                        <FormattedMessage id="project_label.label.default_name" />
                      </FormControl.Label>
...
export type { ProjectLabelFormCardShape }

export default ProjectLabelFormCard
