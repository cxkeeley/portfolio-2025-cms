...
const LanguageForLocationGroupLanguageSelectField: FC<Props> = ({ locationGroupId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForLocationGroupLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForLocationGroupLanguageSelectField
