...
const LanguageForProjectLabelLanguageSelectField: FC<Props> = ({ projectLabelId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForProjectLabelLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForProjectLabelLanguageSelectField
