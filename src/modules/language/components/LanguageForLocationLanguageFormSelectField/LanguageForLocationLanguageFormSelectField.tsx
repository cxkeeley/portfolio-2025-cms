...
const LanguageForLocationLanguageFormSelectField: FC<Props> = ({ locationId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForLocationLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForLocationLanguageFormSelectField
