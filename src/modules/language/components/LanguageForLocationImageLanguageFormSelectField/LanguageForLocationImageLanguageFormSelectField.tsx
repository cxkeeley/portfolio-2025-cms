...
const LanguageForLocationImageLanguageFormSelectField: FC<Props> = ({ locationImageId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForLocationImageLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForLocationImageLanguageFormSelectField
