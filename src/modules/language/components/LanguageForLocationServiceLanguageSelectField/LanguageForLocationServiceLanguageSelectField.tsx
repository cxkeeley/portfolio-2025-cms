...
const LanguageForLocationServiceLanguageSelectField: FC<Props> = ({ locationServiceId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForLocationServiceLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForLocationServiceLanguageSelectField
