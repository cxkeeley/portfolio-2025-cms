...
const LanguageForProjectImageLanguageFormSelectField: FC<Props> = ({ projectImageId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForProjectImageLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForProjectImageLanguageFormSelectField
