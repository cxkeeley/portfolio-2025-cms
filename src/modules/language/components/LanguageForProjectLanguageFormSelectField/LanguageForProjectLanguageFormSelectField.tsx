...
const LanguageForProjectLanguageFormSelectField: FC<Props> = ({ projectId, ...props }) => {
  const searchDebounce = async (inputVal: string, page: number) => {
    const response = await AdminLanguageAPI.getOptionsForProjectLanguageForm({
      ...initialQueryState,
      page,
...
export default LanguageForProjectLanguageFormSelectField
