...
import LanguageForProjectGroupLanguageSelectField from '@modules/language/components/LanguageForProjectGroupSelectField/LanguageForProjectGroupSelectField'
...
type ProjectGroupLanguageFormModalShape = FormShape<{
  image_alt: string
  language_id: Option
  name: string
}>
...
type CategoryLanguageEditFormModalProps = {
  ...
  projectGroupId: ID
  initialValues?: Partial<ProjectGroupLanguageFormModalShape>
  disabledFields?: Partial<FormDisabledFlags<ProjectGroupLanguageFormModalShape>>
  onSubmit: (values: ProjectGroupLanguageFormModalShape) => Promise<void>
  onCancel: () => void
  onHide: () => void
}

const defaultValues: ProjectGroupLanguageFormModalShape = {
  image_alt: '',
  language_id: null,
  name: '',
}

const ProjectGroupLanguageFormModal: FC<CategoryLanguageEditFormModalProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Formik<ProjectGroupLanguageFormModalShape>
              ...
              <Row className="gap-7">
                <Col xs={12}>
                  <FormControl>
                    ...
                    <LanguageForProjectGroupLanguageSelectField
...
export type { ProjectGroupLanguageFormModalShape }

export default ProjectGroupLanguageFormModal
