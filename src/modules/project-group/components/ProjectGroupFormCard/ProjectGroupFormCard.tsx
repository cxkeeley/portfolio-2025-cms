...
type ProjectGroupFormCardShape = FormShape<{
...
type Props = {
  initialValues?: Partial<ProjectGroupFormCardShape>
  initialImageSrc?: string
  onSubmit: (values: ProjectGroupFormCardShape) => Promise<void>
  onCancel: () => void
}

const ProjectGroupFormCard: FC<Props> = ({ initialValues, onSubmit, onCancel, initialImageSrc }) => {
  const alert = useAlert()
  const intl = useIntl()
  const [error, setError] = useState<string>()

  const initialFormValues: ProjectGroupFormCardShape = {
  ...
  return (
    <KTCard>
      <Formik<ProjectGroupFormCardShape>
              ...
              >
                <Row className="gap-7">
                  <Col xs={12}>
                    <FormControl>
                      ...
                      <ImageUploadField
                        ...
                        uploadFn={AdminProjectGroupsAPI.uploadImage}
                  ...
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label isRequired>
                        <FormattedMessage id="project_group.label.default_name" />
                      </FormControl.Label>
                  ...
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label isRequired>
                        <FormattedMessage id="project_group.label.default_image_alt" />
                      </FormControl.Label>
...
export type { ProjectGroupFormCardShape }

export default ProjectGroupFormCard
