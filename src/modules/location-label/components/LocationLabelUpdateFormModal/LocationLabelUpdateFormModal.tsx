...
type LocationLabelUpdateFormModalShape = FormShape<{
  map_icon_file_path: string
}>

type LocationLabelUpdateFormModalProps = {
  isShow: boolean
  modalTitle: React.ReactNode
  initialValues?: Partial<LocationLabelUpdateFormModalShape>
  onSubmit: (values: LocationLabelUpdateFormModalShape) => Promise<void>
  onCancel: () => void
}

const defaultValues: LocationLabelUpdateFormModalShape = {
  map_icon_file_path: '',
}

const LocationLabelUpdateFormModal: FC<LocationLabelUpdateFormModalProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Formik<LocationLabelUpdateFormModalShape>
...
export type { LocationLabelUpdateFormModalShape }

export default LocationLabelUpdateFormModal
