...
import ArticleImage from '../ProjectImage'
...
const ProjectFeaturedImageCard: FC<Props> = ({ imageSrc, cardTitle, cardToolbar }) => {
  return (
    <KTCard flush>
        ...
        {imageSrc ? (
          ...
          <div className='text-center'>
            ...
            <EmptyContentPlaceholder.Title As="h5">
              <FormattedMessage id="project.message.empty_featured_image_placeholder" />
...
export default ProjectFeaturedImageCard
