...
const ProjectProjectGroupSelectField = <IsMulti extends boolean = false>(props: Props<IsMulti>) => {
  const handleSearch = async (keyword: string, page: number) => {
    const { data } = await AdminProjectGroupAPI.getOptionsForProjectForm({
      ...initialQueryState,
      page,
      limit: 10,
...
export default ProjectProjectGroupSelectField
