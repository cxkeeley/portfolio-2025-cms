...
const OurTeamPageTeamTeamSelectField = <IsMulti extends boolean = false>(props: Props<IsMulti>) => {
  const handleSearch = async (keyword: string, page: number) => {
    const { data } = await AdminTeamsAPI.getOptionsForOurTeamPageTeamForm({
      ...initialQueryState,
      page,
...
export default OurTeamPageTeamTeamSelectField
