...
type TeamStartPracticeMonthSelectFieldProps = Omit<SelectFieldProps, 'options'>

export const TeamStartPracticeMonthSelectField: FC<TeamStartPracticeMonthSelectFieldProps> = (props) => {
  const intl = useIntl()
