...
const MainPageLocationGroupSelectField = <IsMulti extends boolean = false>(props: Props<IsMulti>) => {
  const handleSearch = async (keyword: string, page: number) => {
    const { data } = await AdminLocationGroupsAPI.getOptionsForMainPageLocationGroupForm({
      ...initialQueryState,
      page,
