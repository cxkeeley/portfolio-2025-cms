...
type LocationReviewFormModalShape = FormShape<{
...
type Props = {
  ...
  initialValues?: Partial<LocationReviewFormModalShape>
  disabledFields?: Partial<FormDisabledFlags<LocationReviewFormModalShape>>
  hiddenFields?: Partial<FormHiddenFlags<LocationReviewFormModalShape>>
  onSubmit: (values: LocationReviewFormModalShape) => Promise<void>
  onCancel: () => void
  onHide: () => void
}

const defaultValues: LocationReviewFormModalShape = {
...
const LocationReviewFormModal: FC<Props> = (props) => {
  ...
  const handleSubmit = async (
    values: LocationReviewFormModalShape,
    helpers: FormikHelpers<LocationReviewFormModalShape>
  ) => {
    try {
  ...
  return (
    ...
    >
      ...
      <Formik<LocationReviewFormModalShape>
              ...
              <Row className="gap-7">
                  ...
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label isRequired={true}>
                        <FormattedMessage id="location_review.label.client_name" />
                      </FormControl.Label>
                      <TextInputField
                        name="client_name"
                ...
                {!props.hiddenFields?.story && (
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label isRequired={true}>
                        <FormattedMessage id="location_review.label.story" />
                      </FormControl.Label>
                      <TextareaField
                        name="story"
                        rows={5}
                ...
                {!props.hiddenFields?.client_image_file_path && (
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label isRequired={true}>
                        <FormattedMessage id="location_review.label.client_image" />
                      </FormControl.Label>
                      <ImageUploadField
                        name="client_image_file_path"
                        accept={['.png', '.jpg', '.jpeg']}
                        initialImageSrc={props.initialImageSrc}
                        cropperModalTitle={<FormattedMessage id="location_review.section.modal_cropper_image_title" />}
                ...
                {!props.hiddenFields?.client_image_alt && (
                  <Col xs={12}>
                    <FormControl>
                      <FormControl.Label>
                        <FormattedMessage id="location_review.label.client_image_alt" />
                      </FormControl.Label>
                      <TextInputField
...
export type { LocationReviewFormModalShape }

export default LocationReviewFormModal
